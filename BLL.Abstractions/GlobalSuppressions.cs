...
[assembly: SuppressMessage("Naming", "CA1704:Identifiers should be spelled correctly", Justification = "<>", Scope = "member", Target = "~M:BLL.Abstractions.Interfaces.UserInterfaces.IAuthenticationService.GetUserByToken(System.String)~Core.DataClasses.OptionalResult{Core.Models.UserModels.UserModel}")]
