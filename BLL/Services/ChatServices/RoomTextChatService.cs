...
public class RoomTextChatService : IRoomTextChatService
{
    ...
    public async Task<OptionalResult<TextChatModel>> UpdateTextChatInRoomByUser(RoomModel room, UserModel user, ChatEditModel editModel, bool asTransaction = true)
    {
        return asTransaction
            ? await this.transactionsWorker.RunAsTransaction(() =>
    ...
    private async Task<OptionalResult<TextChatModel>> InnerUpdateTextChatInRoomByUser(RoomModel room, UserModel user, ChatEditModel editModel)
    {
