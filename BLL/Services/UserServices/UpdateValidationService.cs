...
{
    internal class UpdateValidationService : IUpdateValidationService
    {
        ...
        public ExceptionalResult ValidateUserName(string username)
        {
        ...
        public ExceptionalResult ValidateEmail(string email)
        {
        ...
        public ExceptionalResult ValidatePassword(string password)
        {
