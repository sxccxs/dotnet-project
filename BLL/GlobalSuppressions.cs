...
[assembly: SuppressMessage("Naming", "CA1704:Identifiers should be spelled correctly", Justification = "<>", Scope = "member", Target = "~M:BLL.Services.UserServices.LoginService.#ctor(BLL.Abstractions.Interfaces.UserInterfaces.IUserService,BLL.Abstractions.Interfaces.UserInterfaces.IJwtService)")]
...
[assembly: SuppressMessage("Naming", "CA1704:Identifiers should be spelled correctly", Justification = "<>", Scope = "member", Target = "~M:BLL.Services.UserServices.UserService.MapUserCreateModel(Core.Models.UserModels.UserCreateModel)~Core.Models.UserModels.UserModel")]
[assembly: SuppressMessage("Naming", "CA1704:Identifiers should be spelled correctly", Justification = "<>", Scope = "member", Target = "~M:BLL.Services.UserServices.UserService.MapUserUpdateModel(Core.Models.UserModels.UserUpdateModel)~Core.Models.UserModels.UserModel")]
...
[assembly: SuppressMessage("Naming", "CA1704:Identifiers should be spelled correctly", Justification = "<>", Scope = "member", Target = "~M:BLL.Services.UserServices.TokenGeneratorService.GetIdFromUidb64(System.String)~System.Int32")]
...
[assembly: SuppressMessage("Naming", "CA1704:Identifiers should be spelled correctly", Justification = "<>", Scope = "member", Target = "~M:BLL.Services.RoomServices.GetRoomsService.GetRoomsForUser(System.String)~System.Collections.Generic.IEnumerable{Core.Models.RoomModels.RoomModel}")]
[assembly: SuppressMessage("Naming", "CA1704:Identifiers should be spelled correctly", Justification = "<>", Scope = "member", Target = "~M:BLL.Services.RoomServices.GetRoomsService.#ctor(BLL.Abstractions.Interfaces.RoomInterfaces.IUserRoomService,BLL.Abstractions.Interfaces.UserInterfaces.IUserService,BLL.Abstractions.Interfaces.UserInterfaces.IJwtService)")]
[assembly: SuppressMessage("Naming", "CA1704:Identifiers should be spelled correctly", Justification = "<>", Scope = "member", Target = "~F:BLL.Services.RoomServices.GetRoomsService.jwtService")]
...
[assembly: SuppressMessage("Naming", "CA1704:Identifiers should be spelled correctly", Justification = "<>", Scope = "member", Target = "~M:BLL.Services.UserServices.AuthenticationService.GetUserByToken(System.String)~Core.Models.UserModels.UserModel")]
