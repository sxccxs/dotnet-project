...
[assembly: SuppressMessage("Naming", "CA1704:Identifiers should be spelled correctly", Justification = "<>", Scope = "member", Target = "~M:BLL.Services.UserServices.AuthenticationService.GetUserByToken(System.String)~Core.DataClasses.OptionalResult{Core.Models.UserModels.UserModel}")]
